...
messageSpan.querySelector("#hideVineItems-filtersMenu").addEventListener("click", (e) => {document.querySelector(".dropdown .dropdown-content").classList.toggle("dropdown-click");});
